        ...
        <>
            <header className="navbar8-container1">
                    ...
                    <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
                        <nav className="navbar8-links1">
                            ...
                            >
                                {props.link1 ?? (
                                    <Fragment>
                                        <span className="navbar8-text14">#</span>
                                    </Fragment>
                                )}
                            </a>
                            <a href={props.link2Url} className="thq-link thq-body-small">
                                {props.link2 ?? (
                                    <Fragment>
                                        <span className="navbar8-text25">#</span>
                                    </Fragment>
                                )}
                            </a>
                            <a
                            ...
                            >
                                {props.link3 ?? (
                                    <Fragment>
                                        <span className="navbar8-text15">#</span>
                                    </Fragment>
                                )}
                            </a>
                            <div
                ...
                <span className="thq-link thq-body-small">
                  {props.link4 ?? (
                      <Fragment>
                          <span className="navbar8-text24">#</span>
                      </Fragment>
                  )}
                </span>
                ...
                <span>
                  {props.action1 ?? (
                      <Fragment>
                          <span className="navbar8-text19">Main Action</span>
                      </Fragment>
                  )}
                </span>
                            </button>
                ...
                <span>
                  {props.action2 ?? (
                      <Fragment>
                          <span className="navbar8-text23">Secondary Action</span>
                      </Fragment>
                  )}
                </span>
                            </button>
                      ...
                      {props.link4 ?? (
                          <Fragment>
                            ...
                            <span className="navbar8-page21 thq-body-large">
                              {props.page2 ?? (
                                  <Fragment>
                                      <span className="navbar8-text21">About</span>
                                  </Fragment>
                              )}
                            </span>
                                                        <span className="thq-body-small">
                  ...
                  <span>
                    ...
                    {link5DropdownVisible && (
                      ...
                      <span className="navbar8-page32 thq-body-large">
                        {props.page3 ?? (
                            <Fragment>
                                <span className="navbar8-text26">Services</span>
                            </Fragment>
                        )}
                      </span>
                                            <span className="thq-body-small">
...
Navbar8.defaultProps = {
    page4ImageSrc:
        'https://images.unsplash.com/photo-1544474560-5b2a788d024a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODkyODQxN3w&ixlib=rb-4.0.3&q=80&w=1080',
    page3ImageSrc:
        'https://images.unsplash.com/photo-1492724441997-5dc865305da7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODkyODQxOHw&ixlib=rb-4.0.3&q=80&w=1080',
    link1: undefined,
    ...
    link3: undefined,
    page1ImageSrc:
        'https://images.unsplash.com/photo-1564346793829-64d18c73a416?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODkyODQxNnw&ixlib=rb-4.0.3&q=80&w=1080',
    page1ImageAlt: 'image',
    ...
    page2ImageAlt: 'image',
    page2ImageSrc:
        'https://images.unsplash.com/photo-1629203805267-de9c6225e6de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODkyODQxN3w&ixlib=rb-4.0.3&q=80&w=1080',
    logoAlt: 'Logo',
